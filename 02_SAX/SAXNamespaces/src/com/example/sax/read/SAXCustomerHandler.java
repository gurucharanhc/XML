...
//			data.add(customer);
			if(uri.equalsIgnoreCase("http://www.example.org/customers")){
				customer = new Customer();
				String idAsString = attributes.getValue(Customer.ID);
				customer.setId(Integer.parseInt(idAsString));
				data.add(customer);
...
//		System.out.println("End element: " + qName);
		...
		if (currentElement.equals("customers") || currentElement.equals("customer") || !uri.equalsIgnoreCase("http://www.example.org/customers")) {
			return;
		}
